...
namespace KNN
{
     internal class BasicSectionData : IRecordSectionData
     {
          ...
          private Double m_avgInterval;   // should be easier to use intervals array and calculate when required
          ...
          private void init(List<IRecordSliceData> slices)
          {
               ...
               foreach (IRecordSliceData slice in slices)
               {
                    ...
                    if (slice.getLastRecognitionTime() != null)
                    {
                    ...
                    if (slice.getAmountOfTargetSoundRecognitions() > 0)
                    {
                         ...
                         //}
                         m_recognitions.AddRange(slice.getRecognitionsList());
                    }
               }
