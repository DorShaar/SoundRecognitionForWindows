...
namespace KNN
{
     internal class RecordNeighbor : INeighbor
     {
          ...
          public double[] PrepareFixedParameters()
          {
               ...
               fixedParameters.Add(MinInterval); //TODO: maybe add some params with small values more then ones, to make them more effective
               fixedParameters.Add(MaxInterval);
               fixedParameters.Add(AvgInterval);

               fixedParameters.Add(LastSectionTimeSpan);//TODO: make those more effective, maybe add weight
          ...
          }//TODO: also can add weight to the distance in the last part of the knn
          ...
          //    double[] distances = new double[parameters.Count];

          //    for (int i = 0; i < parameters.Count; i++)
          //    {
          //        distances[i] = Math.Pow((parameters[i] - other.getParameter(i)), 2);
          //    }
          //    distance = Math.Sqrt(distances.Sum());
